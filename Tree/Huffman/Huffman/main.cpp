...
using namespace std;
///动态哈夫曼编码
///此程序仅用于演示原理，并不能真正压缩数据，因为为了方便观看，并没有采用二进制输出^_^
...
int main() {
    cout << "HuffmanTree::encode(\"aabbcccaabcccabababccc\"):" << endl;
    cout << HuffmanTree::encode("aabbcccaabcccabababccc") << endl;
    cout << HuffmanTree::decode(HuffmanTree::encode("Python是世界上最好的语言").c_str());
